...
var app = (function () {
    ...
    */
    ...
    /* node_modules/svelte-chartjs/src/Base.svelte generated by Svelte v3.29.7 */
    const file = "node_modules/svelte-chartjs/src/Base.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas, file, 42, 0, 789);
    		},
    ...
    /* node_modules/svelte-chartjs/src/Line.svelte generated by Svelte v3.29.7 */
    ...
    /* src/services/ApiService.svelte generated by Svelte v3.29.7 */
    ...
    /* src/components/Chart.svelte generated by Svelte v3.29.7 */

    // (72:0) {#if dataPerWeek.loaded}
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const line_changes = {};
    			if (dirty & /*dataLine*/ 2) line_changes.data = /*dataLine*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(72:0) {#if dataPerWeek.loaded}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*dataPerWeek*/ ctx[0].loaded && create_if_block(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*dataPerWeek*/ ctx[0].loaded) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*dataPerWeek*/ 1) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let dataPerWeek = { loaded: false, data: [] };
    	let dataSetDate = [], dataSetRate = [];

    	onMount(async () => {
    		getExchangeData().then(resp => {
    			$$invalidate(0, dataPerWeek.loaded = true, dataPerWeek);
    			$$invalidate(0, dataPerWeek.data = resp.reverse(), dataPerWeek);
    	...
    	$$self.$inject_state = $$props => {
    		if ("dataPerWeek" in $$props) $$invalidate(0, dataPerWeek = $$props.dataPerWeek);
    		if ("dataSetDate" in $$props) $$invalidate(3, dataSetDate = $$props.dataSetDate);
    		if ("dataSetRate" in $$props) $$invalidate(4, dataSetRate = $$props.dataSetRate);
    		if ("dataLine" in $$props) $$invalidate(1, dataLine = $$props.dataLine);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*dataPerWeek*/ 1) {
    			 if (dataPerWeek.loaded) {
    				$$invalidate(1, dataLine.labels = dataSetDate, dataLine);
    				$$invalidate(1, dataLine.datasets[0].data = dataSetRate, dataLine);
    			}
    		}
    	};

    	return [dataPerWeek, dataLine, options];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			h1 = element("h1");
    			h1.textContent = "USD exchange to UAH per period according to NBU";
    			t1 = space();
    			div1 = element("div");
    			create_component(chart.$$.fragment);
    			attr_dev(h1, "class", "h2");
    			add_location(h1, file$1, 9, 16, 331);
    			attr_dev(div0, "class", "d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom");
    			add_location(div0, file$1, 8, 12, 197);
    			attr_dev(main, "class", "col-md-12 ml-sm-auto col-lg-12 px-md-4");
    			add_location(main, file$1, 7, 8, 131);
    			attr_dev(div1, "class", "col-md-12");
    			add_location(div1, file$1, 12, 8, 442);
    			attr_dev(div2, "class", "row");
    			add_location(div2, file$1, 6, 4, 105);
    			attr_dev(div3, "class", "container-fluid");
    			add_location(div3, file$1, 5, 0, 71);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
